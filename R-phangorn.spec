...
Version  : 2.12.1
Release  : 51
URL      : https://cran.r-project.org/src/contrib/phangorn_2.12.1.tar.gz
Source0  : https://cran.r-project.org/src/contrib/phangorn_2.12.1.tar.gz
...
%setup -q -n phangorn
pushd ..
cp -a phangorn buildavx2
popd
pushd ..
cp -a phangorn buildavx512
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1726676926
...
/usr/lib64/R/library/phangorn/tests/testthat/_snaps/plot_ancestral/pie-plots.svg
/usr/lib64/R/library/phangorn/tests/testthat/_snaps/plot_ancestral/seqlogo.svg
/usr/lib64/R/library/phangorn/tests/testthat/_snaps/plot_networx/plot-networx.svg
/usr/lib64/R/library/phangorn/tests/testthat/_snaps/plot_pml/densitree.svg
/usr/lib64/R/library/phangorn/tests/testthat/_snaps/plot_pml/plot-pml.svg
/usr/lib64/R/library/phangorn/tests/testthat/test_plot_ancestral.R
/usr/lib64/R/library/phangorn/tests/testthat/test_plot_networx.R
/usr/lib64/R/library/phangorn/tests/testthat/test_plot_pml.R
...
/usr/lib64/R/library/phangorn/tinytest/test_add_edge_length.R
...
/usr/lib64/R/library/phangorn/tinytest/test_readnexus_multi.R
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/R/library/phangorn/libs/phangorn.so
/V4/usr/lib64/R/library/phangorn/libs/phangorn.so
